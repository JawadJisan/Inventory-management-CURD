...
const Login = () => {
    ...
    return (
        <div className='container mt-5 w-50 mx-auto'>
            <h3 className='mb-10 text-center text-2xl font-semibold m-3 bg-red-300 p-3 rounded-3xl'> Please <span className='font-extrabold text-red-900'>Login</span> first to see the Product List</h3>
