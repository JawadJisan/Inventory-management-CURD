...
const Registration = () => {
    ...
    return (
        <div className='registration-container'>
            <h3 className='mb-10  text-center text-2xl font-semibold m-3  p-3 rounded-3xl'> Please <span className='font-extrabold text-red-900'>registration</span> first to see the Product List</h3>
            <h5 className='text-center header mt-5 p-3'>Create Account</h5>
